...
function testSpeed() {
    ...
    const nPendulums = 1000;
    
    const colorValues = getColorBuffer(nPendulums).map(x => 0)
    ...
    console.log(elapsedTime/nFrames)

    return Math.floor((1000/60) / (elapsedTime / nFrames) * nPendulums);
}
